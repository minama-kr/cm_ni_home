...
<body>
	...
	%>		
			...
			<div style="text-align:right;">
				<a href="/news/elder_album.asp" title="어르신앨범 목록으로 돌아가기" style="background:url(/images/btn/bg_list_btn.jpg) no-repeat 0 top; width:74px; height:27px; line-height:27px; display:inline-block; text-align:center; font-size:13px; font-weight:bold; margin-top:13px;">목록</a>
			</div>
			<div class="near_list">
				<ul>
					<li>이전글</li>
