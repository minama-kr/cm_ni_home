...
<body>
	...
	<div style="width:958px; margin:0 auto; overflow:hidden;">
		...
		<!-- 서브 페이지 컨텐츠 입력 -->
			<div style="background:url(/images/page/news/hospital_album_bg_top.jpg) no-repeat 0 top; width:100%; height:246px; margin-bottom:22px;">
				<h2>병원앨범</h2>
				<h4 class="blind">
					환자와 함께 모든 임직원이 가족과 같은 마음을 갖고 있습니다.
				</h4>
				<p class="blind">
					천안시립노인전문병원은 늘 즐거운 마음으로 함께하, 환자분들을 가진의 가족을 대하는 마음으로 성심을 다하고 있습니다. 어르신들이 즐겁게 병세를 치유하실 수 있도록 임직원들 모두 최선을 다합니다.
				</p>
			</div>
	<%
		'DB 연결
	...
	%>
			<div class="hospital_list" style="<%=strMargin%>">
				...
				<div class="hospital_list_bg" style="background:url(/images/page/news/bg_list_health.jpg) repeat-y 0 top; padding:0 17px 0 20px;">
					...
					<a href="/news/hospital_album_detail.asp?key=<%=objRecord("BBS_KEY")%>&dvs=<%=objRecord("BBS_DVS")%>" class="thmb_img">
					...
					<ul class="header">
						<li class="title"><a href="/news/hospital_album_detail.asp?key=<%=objRecord("BBS_KEY")%>&dvs=<%=objRecord("BBS_DVS")%>" title="병원앨범 상세보기 이동"><img src="/images/page/news/icon_readMore.jpg" alt="">Read More</a></li>
