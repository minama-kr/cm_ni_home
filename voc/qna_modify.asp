			...
			%>
				...
				<div class="edit">
					<div class="top_bd_black">
						...
						<label for="pSecretYn">비공개 여부</label>
						<input type="checkbox" id="pSecretYn" name="pSecretYn" <% If objRecord("SCRT_YN") = "Y" Then %> checked="checked" <% End If %> />
					</div>
					<div class="top_bd_silver">
						<label for="pEMail">이메일</label>
						<input type="text" id="pEMail" name="pEMail" class="placeholder  col1" placeholder="이메일을 입력해주세요." maxlength="100" value="<%=strEMail%>" />
						<span class="blind">* 필수입력란 입니다.</span>
