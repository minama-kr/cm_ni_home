				...
				success : function(result){
					if(result == "true"){
						...
						if(type == "r"){
							...
							window.location =  "/voc/praise_modify.asp?key=" + $("#pKey").val() + "&dvs=" +$("#pDvs").val() + "&pswd=" + pswd;
						}
					}else{
...
<body>
	...
	<div class="wrap" style="overflow:hidden;">
		...
		%>
			...
			<div class="right btn">
				<a class="btn_big blue" href="/voc/praise_modify.asp" title="칭찬합시다 목록으로 돌아가기">새글쓰기</a>
				<a class="btn_big gray" href="/voc/praise.asp" title="칭찬합시다 목록으로 돌아가기">목록</a>
			</div>
